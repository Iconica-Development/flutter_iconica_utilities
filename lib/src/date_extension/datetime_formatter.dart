...
/// Formats the given [date] into a string representation of day, month, and year.
///
/// The [separator] parameter is optional and defaults to "/". It specifies the separator
/// character to be used between the day, month, and year components in the formatted string.
///
/// Example:
/// ```dart
...
/// Formats the given [date] into a string representation of the hour and minute in 24-hour format.
///
/// Example:
/// ```dart
...
/// Formats the given [date] into a string representation of hour, minute, and second.
///
